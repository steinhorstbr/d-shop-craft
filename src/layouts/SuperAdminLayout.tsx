...
import {
  LayoutDashboard, Store, CreditCard, Settings, Users, LogOut,
  Building2, MessageSquare, Box
} from "lucide-react";
...
const navItems = [
  ...
  { href: "/super-admin/stores", label: "Empresas", icon: Building2 },
  { href: "/super-admin/plans", label: "Planos", icon: CreditCard },
  { href: "/super-admin/config", label: "Configurações", icon: Settings },
];
